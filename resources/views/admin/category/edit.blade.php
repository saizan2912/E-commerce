        ...
        <div class="x_content">
            ...
            <form id="demo-form2" action="{{route('category.update',$category->id)}}" method="post" data-parsley-validate="" class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Category Name <span
                            class="required">*</span>
                    </label>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="category_id">Sub Category<span
                            class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="category_id" id="category_id" class="form-control com-sm-7 col-xs-12">
                            <option value="" @if ($category->category_id==null) selected @endif>No SubCategary</option>
