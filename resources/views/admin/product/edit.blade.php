...
@section('content')
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <form id="demo-form2" action="{{route('product.update',$product->id)}}" method="post" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left">
                @csrf
