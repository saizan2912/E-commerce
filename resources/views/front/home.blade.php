...
@section('content')
    <div class="span9">
        ...
        <ul class="thumbnails">
            ...
            <li class="span3">
                <div class="thumbnail">
                    <a href="{{route('productView',$value->id)}}"><img src="{{asset('uploads/'.$new_product->image)}}" alt="" /></a>
                    <div class="caption">
                        <h5>{{$new_product->name}} </h5>
                        <h4 style="text-align:center"><a class="btn" href="{{route('productView',$value->id)}}"> <i
                                    class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to
                                <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary"
                                href="#">{{$new_product->price}}</a></h4>
                    </div>
                </div>
            </li>
            @endforeach
